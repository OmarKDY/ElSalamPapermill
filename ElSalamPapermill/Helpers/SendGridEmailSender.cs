...
namespace ElSalamPapermill.Helpers
{
    ...
    {
        Task SendEmailAsync(string fromEmail, string toEmail, string subject, object body);
    }
    ...
    public class SendGridEmailSender : IEmailSender
    {
        ...
        public async Task SendEmailAsync(string fromEmail, string toEmail, string subject, object body)
        {
        ...
        {
            // Extract the required properties from the `body` object and format them as plain text
            var orderDetail = (OrderDetail)body;
            var plainTextContent = $"Order Id: {orderDetail.OrderGuid}\n" +
